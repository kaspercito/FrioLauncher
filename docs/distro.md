...
The most up to date and accurate descriptions of the distribution spec can be viewed in [frio-distribution-types](https://github.com/kaspercito/frio-distribution-types).
